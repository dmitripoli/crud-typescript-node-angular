...
var page_not_found_component_1 = __webpack_require__("../../../../../src/app/component/page-not-found/page-not-found.component.ts");
...
var material_module_1 = __webpack_require__("../../../../../src/app/modules/material/material.module.ts");
var page_not_found_component_1 = __webpack_require__("../../../../../src/app/component/page-not-found/page-not-found.component.ts");
var crud_module_1 = __webpack_require__("../../../../../src/app/modules/crud/crud.module.ts");
...
/***/ "../../../../../src/app/modules/crud/component/crud-item/crud-item.component.html":
/***/ (function(module, exports) {

module.exports = "<h1 mat-dialog-title>{{data.actionTitle}}</h1>\n<div mat-dialog-content>\n  <form *ngIf=\"formData\" novalidate [formGroup]=\"formData\">\n    <div *ngFor=\"let prop of dataProps\">\n      <label [attr.for]=\"prop\">{{prop}} : </label>\n      <input [formControlName]=\"prop\">\n    </div>\n  </form>\n</div>\n<div mat-dialog-actions>\n  <button mat-button (click)=\"Cancel()\">Cancel</button>\n  <button mat-button (click)=\"closeDialog()\" cdkFocusInitial>Save</button>\n</div>"

/***/ }),

/***/ "../../../../../src/app/modules/crud/component/crud-item/crud-item.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/modules/crud/component/crud-item/crud-item.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
var CrudItemComponent = /** @class */ (function () {
    function CrudItemComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.formData = null;
    }
    CrudItemComponent.prototype.ngOnInit = function () {
        var formGroup = {};
        this.dataProps = Object.keys(this.data.data);
        for (var _i = 0, _a = Object.keys(this.data.data); _i < _a.length; _i++) {
            var prop = _a[_i];
            formGroup[prop] = new forms_1.FormControl(this.data.data[prop] || "");
        }
        this.formData = new forms_1.FormGroup(formGroup);
        console.log(this.formData.getRawValue());
    };
    CrudItemComponent.prototype.Cancel = function () {
        this.dialogRef.close();
    };
    CrudItemComponent.prototype.closeDialog = function () {
        this.data.data = this.formData.getRawValue();
        this.dialogRef.close(this.data);
    };
    CrudItemComponent = __decorate([
        core_1.Component({
            selector: "app-crud-item",
            template: __webpack_require__("../../../../../src/app/modules/crud/component/crud-item/crud-item.component.html"),
            styles: [__webpack_require__("../../../../../src/app/modules/crud/component/crud-item/crud-item.component.scss")]
        }),
        __param(1, core_1.Inject(material_1.MAT_DIALOG_DATA)),
        __metadata("design:paramtypes", [material_1.MatDialogRef, Object])
    ], CrudItemComponent);
    return CrudItemComponent;
}());
exports.CrudItemComponent = CrudItemComponent;


/***/ }),

/***/ "../../../../../src/app/modules/crud/component/crud-table/crud-table.component.html":
/***/ (function(module, exports) {

module.exports = "<mat-table *ngIf=\"dataArray\" #table [dataSource]=\"dataArray\">\n    <ng-container matColumnDef=\"{{column.property}}\" *ngFor=\"let column of columnNames ; let index = $index\">\n        <mat-header-cell *matHeaderCellDef mat-sort-header> {{column.header}} </mat-header-cell>\n        <mat-cell *matCellDef=\"let element\"> {{element[column.property]}}\n        </mat-cell>\n    </ng-container>\n    <ng-container matColumnDef=\"actionsColumn\">\n        <mat-header-cell *matHeaderCellDef>\n            <button (click)=\"createNew()\">Create new</button>\n        </mat-header-cell>\n        <mat-cell *matCellDef=\"let row\">\n            <button (click)=\"edit(row)\">Edit</button>\n            <button (click)=\"delete(row)\">Delete</button>\n        </mat-cell>\n    </ng-container>\n    <mat-header-row *matHeaderRowDef=\"displayedColumns\"></mat-header-row>\n    <mat-row *matRowDef=\"let row; columns: displayedColumns;\">\n    </mat-row>\n</mat-table>"

/***/ }),

/***/ "../../../../../src/app/modules/crud/component/crud-table/crud-table.component.scss":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/modules/crud/component/crud-table/crud-table.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("../../../core/esm5/core.js");
var crud_service_1 = __webpack_require__("../../../../../src/app/modules/crud/crud.service.ts");
var material_1 = __webpack_require__("../../../material/esm5/material.es5.js");
var core_2 = __webpack_require__("../../../core/esm5/core.js");
var crud_item_component_1 = __webpack_require__("../../../../../src/app/modules/crud/component/crud-item/crud-item.component.ts");
...
var CrudTableComponent = /** @class */ (function () {
    function CrudTableComponent(crudService, dialog) {
    ...
    CrudTableComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.crudService.get().subscribe(function (res) {
            _this.dataArray = new material_1.MatTableDataSource(res);
        });
        this.displayedColumns = this.columnNames.map(function (x) { return x.property; });
        this.displayedColumns.push("actionsColumn");
    };
    CrudTableComponent.prototype.createNew = function () {
        var _this = this;
        var itemProperties = _.cloneDeep(this.displayedColumns);
        itemProperties.pop();
        var newObjectData = {};
        itemProperties.map(function (p) { return (newObjectData[p] = ""); });
        var dialogRef = this.dialog.open(crud_item_component_1.CrudItemComponent, {
            width: "250px",
            data: {
        ...
        dialogRef
            ...
            _this.crudService.post(result.data).subscribe(function (res) {
                _this.dataArray.data.push(res);
                _this.table.renderRows();
            });
        });
    };
    CrudTableComponent.prototype.delete = function (data) {
        var _this = this;
        var id = data._id;
        this.crudService.delete(id).subscribe(function (res) {
            _.remove(_this.dataArray.data, { _id: id });
            _this.table.renderRows();
        });
    };
    CrudTableComponent.prototype.edit = function (data) {
        var _this = this;
        var dialogRef = this.dialog.open(crud_item_component_1.CrudItemComponent, {
            width: "250px",
            data: {
        ...
        dialogRef
            ...
            .pipe(operators_1.takeUntil(this.ngUnsubscribe))
            .subscribe(function (result) {
            _this.crudService.put(result.data).subscribe(function (res) {
                var editedItemIndex = _this.dataArray.data.findIndex(function (item) { return item._id === res._id; });
                _this.dataArray.data[editedItemIndex] = res;
                _this.table.renderRows();
            });
        });
    };
    ...
    __decorate([
        core_2.ViewChild("table"),
        __metadata("design:type", material_1.MatTable)
    ], CrudTableComponent.prototype, "table", void 0);
    CrudTableComponent = __decorate([
        core_1.Component({
            selector: "app-crud-table",
            template: __webpack_require__("../../../../../src/app/modules/crud/component/crud-table/crud-table.component.html"),
            styles: [__webpack_require__("../../../../../src/app/modules/crud/component/crud-table/crud-table.component.scss")]
        }),
        __metadata("design:paramtypes", [crud_service_1.CrudService, material_1.MatDialog])
    ], CrudTableComponent);
    return CrudTableComponent;
}());
exports.CrudTableComponent = CrudTableComponent;
// const orgData = _.cloneDeep(this.dataArray.data);
// let editedItemRef = orgData.find(item => item._id === res._id);
// editedItemRef = res;
// this.dataArray = new MatTableDataSource(orgData);
// console.log(this.dataArray);


/***/ }),

/***/ "../../../../../src/app/modules/crud/crud-routs.module.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var common_1 = __webpack_require__("../../../common/esm5/common.js");
var router_1 = __webpack_require__("../../../router/esm5/router.js");
var crud_table_component_1 = __webpack_require__("../../../../../src/app/modules/crud/component/crud-table/crud-table.component.ts");
var routes = [
    {
        path: "crud",
        component: crud_table_component_1.CrudTableComponent
    }
];
var CrudRoutesModule = /** @class */ (function () {
    function CrudRoutesModule() {
    }
    CrudRoutesModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, router_1.RouterModule.forChild(routes)],
            declarations: []
        })
    ], CrudRoutesModule);
    return CrudRoutesModule;
}());
exports.CrudRoutesModule = CrudRoutesModule;
...
var common_1 = __webpack_require__("../../../common/esm5/common.js");
var crud_table_component_1 = __webpack_require__("../../../../../src/app/modules/crud/component/crud-table/crud-table.component.ts");
var crud_routs_module_1 = __webpack_require__("../../../../../src/app/modules/crud/crud-routs.module.ts");
var crud_service_1 = __webpack_require__("../../../../../src/app/modules/crud/crud.service.ts");
var material_module_1 = __webpack_require__("../../../../../src/app/modules/material/material.module.ts");
var crud_item_component_1 = __webpack_require__("../../../../../src/app/modules/crud/component/crud-item/crud-item.component.ts");
var forms_1 = __webpack_require__("../../../forms/esm5/forms.js");
var CrudModule = /** @class */ (function () {
    ...
    CrudModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule,
                crud_routs_module_1.CrudRoutesModule,
                material_module_1.MaterialModule,
                forms_1.FormsModule,
                forms_1.ReactiveFormsModule
            ],
            providers: [crud_service_1.CrudService],
            entryComponents: [crud_item_component_1.CrudItemComponent],
            declarations: [crud_table_component_1.CrudTableComponent, crud_item_component_1.CrudItemComponent]
        })
    ], CrudModule);
    return CrudModule;
}());
...
/***/ "../../../../../src/app/modules/crud/crud.service.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var CrudService = /** @class */ (function () {
    ...
    CrudService.prototype.put = function (data) {
        return this.http.put("/contact/" + data._id, data);
    };
    CrudService.prototype.post = function (data) {
